...
const Catalog = (props) => {
  useDisableScroll(props.isLoading);

  useEffect(() => {
    props.GetPopulars(1, 5);
    props.GetRecommends(1, 5);
    props.GetAvailables(1, 10);
    props.GetCategory(1, 10);
  }, []);
  ...
  return (
    <div className="content">
      ...
      <Banner
        ...
        subtitle={"Возьми с собой домкрат"}
      />
      ...
      <Banner
        green={true}
        title={"Смотри в оба"}
        subtitle={"Главное - внимательность!"}
      />
