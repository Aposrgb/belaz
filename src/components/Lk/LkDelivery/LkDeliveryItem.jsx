      ...
      <div className={style.top}>
        ...
        <div>
          ...
          <div className={style.topText}>
            Дата доставки: {props.dateDelivery}
          </div>
        </div>
      </div>
      <div className={style.body}>
        ...
        <div className={style.orderBlock}>
          <div className={style.text}>
            ...
            <span>{props.dateRegistration}</span>
          </div>
          ...
          <div className={style.text}>
            ...
            <span className={style.color}>{props.paymentState}</span>
          </div>
          <div className={style.titleOrder}>Способ получения</div>
          <div className={style.text}>
          ...
          <div className={style.text}>
            <div> Получатель:</div>
            <span>
              {props.receiverName} {props.receiverSurname}
            </span>
          </div>
          <div className={style.text}>
          ...
          <div className={style.flex}>
            ...
            <div onClick={handleCancelOrder} className={style.btn}>Отменить заказ</div>
          </div>
        </div>
      </div>
    </div>
